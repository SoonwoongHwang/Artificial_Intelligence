...
# Custom Model Load 
model = torch.hub.load('ultralytics/yolov5', 'custom', path='/home/kimi/work/yolov5/runs/train/exp4/weights/best.pt')
# model = torch.hub.load('ultralytics/yolov5', 'yolov5s')  # Original model 

# # Images detection 
# img1 = Image.open('test1.jpg')  # PIL image
...
#     cv2.imshow('Pallet recognition', img[0])
